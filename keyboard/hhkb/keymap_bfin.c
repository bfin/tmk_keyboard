...
const uint8_t keymaps[][MATRIX_ROWS][MATRIX_COLS] PROGMEM = {
     ...
     * Change Left Control to Escape / Left Control
     * Change Space to Space / Layer 2
     * ,-----------------------------------------------------------.
    ...
    KEYMAP(TRNS, F1,  F2,  F3,  F4,  F5,  F6,  F7,  F8,  F9,  F10, F11, F12, TRNS,TRNS,   \
           ...
           TRNS,TRNS,TRNS,MPRV,MNXT,TRNS,LEFT,DOWN,UP,RGHT,TRNS,TRNS,TRNS,            \
